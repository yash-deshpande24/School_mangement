...
const getStudentsAttendaceOfClassAndDate = async (req, res) => {
    try {
        ...
        const enrollments = await ClassEnrollments.findAll({
            where: { classId: classId, clientId: storeClientId, sectionId: sectionExist.id },
...
module.exports = getStudentsAttendaceOfClassAndDate;
